...
public class SniperTurret : MonoBehaviour
{
    ...
    [Header("Attributes")]
    [SerializeField] private float targetingRange = 10f; // Increased range for sniper
    [SerializeField] private float rotationSpeed = 100f; // Slower rotation for sniper
    [SerializeField] private float bps = 0.5f; // Lower firing rate for sniper
    ...
    {
        Handles.color = Color.red; // Different color for the sniper turret range indicator
